...
var Crawler = /** @class */ (function () {
    function Crawler() {
        ...
        this.url = "https://song-api.only0129.top/slides";
    ...
    // 分析组装数据
    Crawler.prototype.analyzerData = function (html) {
        // console.log(html);
        var data = JSON.parse(html);
        return { time: new Date().getTime(), data: data.data };
    };
    // 获取文件数据、添加数据
    Crawler.prototype.getJsonContent = function (slideData) {
    ...
    Crawler.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            var filePath, html, data, fileContent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        html = _a.sent();
                        data = this.analyzerData(html);
                        fileContent = this.getJsonContent(data);
                        // console.log(data);
